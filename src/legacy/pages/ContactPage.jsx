...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 1. Send email via EmailJS (works from browser - no backend needed)
      try {
      ...
      // 2. Save to Firebase Firestore (always works now)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl md:text-7xl font-display font-extrabold mb-6 md:mb-8 tracking-tight"
            >
              Let's <span className="text-gray-600 italic">Connect.</span>
            </motion.h1>

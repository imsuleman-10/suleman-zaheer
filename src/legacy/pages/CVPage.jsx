    ...
    <div className="min-h-screen bg-[#f1f5f9] text-[#0f172a] font-sans selection:bg-primary/20">
      ...
      <div className="bg-white border-b border-slate-200 py-3 px-6 no-print sticky top-0 z-50">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 text-slate-500 hover:text-primary transition-colors font-medium text-sm">
      ...
      <div className="max-w-[850px] mx-auto my-6 md:my-8 bg-white shadow-xl overflow-hidden print:m-0 print:shadow-none print:w-full print:h-[11in]">
        ...
        <div className="bg-slate-900 text-white p-6 md:p-10 border-b-4 border-primary">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="text-3xl md:text-5xl font-black tracking-tighter mb-1">SULEMAN ZAHEER</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-[11px] md:text-xs text-slate-300">
              ...
              <div className="flex items-center gap-2"><Globe size={12} className="text-primary" /> suleman.tech</div>
            </div>
          </div>
        </div>
          ...
          <div className="md:col-span-8 p-6 md:p-10 space-y-8">
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed text-[13px]">
                Passionate Computer Science student at UET Lahore (3rd Semester) with a drive for building high-performance web applications. Specialized in the MERN stack with extensive experience in PHP/Laravel and C++. Dedicated to clean code and architecting scalable digital solutions.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="relative pl-4 border-l-2 border-slate-100">
                  ...
                  <p className="text-primary font-bold text-[11px]">UET Lahore | 2024 - Present</p>
                  <p className="text-slate-500 text-[12px] mt-1 italic">3rd Semester Candidate</p>
                </div>
                <div className="relative pl-4 border-l-2 border-slate-100">
            ...
            <section>
              ...
              <div className="text-[11px] text-slate-600 space-y-2">
                ...
                <ul className="space-y-1">
                  ...
                  <li className="flex items-center gap-2"><span className="w-1 h-1 bg-primary rounded-full"/> MERN Internships</li>
                  <li className="flex items-center gap-2"><span className="w-1 h-1 bg-primary rounded-full"/> Remote Freelance</li>
                </ul>
              </div>
            </section>
